...
const DryBagIIIProduct = () => {
  ...
  const specifications = [
    ...
    { label: t("drybagIII.spec.duration"), value: t("drybagIII.spec.durationValue") },
    { label: t("drybagIII.spec.temp"), value: t("drybagIII.spec.tempValue") },
    { label: t("drybagIII.spec.shelf"), value: t("drybagIII.spec.shelfValue") },
  ...
  const features = [
    ...
    { icon: Shield, title: t("drybagIII.feature2.title") },
    { icon: Package, title: t("drybagIII.feature3.title") },
  ];
  const applications = [t("drybagIII.app1"),t("drybagIII.app2"),t("drybagIII.app3"),t("drybagIII.app4"),t("drybagIII.app5"),t("drybagIII.app6")];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <MoistureBackground variant="large" className="bg-background">
        <section className="py-12 lg:py-20"><div className="container mx-auto px-4 lg:px-8"><div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="relative group">
            ...
            <div className="relative aspect-square rounded-xl overflow-hidden border border-border bg-gradient-to-br from-muted/80 via-muted/40 to-accent/30">
              ...
              <img src={productDrybagIII} alt="DRY-BAG III Bentonite Clay Desiccant" className="w-full h-full object-contain p-8 transition-transform duration-700 group-hover:scale-105 relative z-10" />
          ...
          <div className="space-y-6">
            <div>
              <span className="inline-block px-4 py-1.5 mb-4 text-xs font-semibold tracking-widest uppercase bg-primary/10 text-primary border border-primary/20 rounded-full">{t("drybagIII.tagline")}</span>
              <h1 className="text-4xl lg:text-5xl font-black tracking-tight mb-4">{t("drybagIII.title")}<span className="text-gradient">{t("drybagIII.titleHighlight")}</span></h1>
              <p className="text-lg text-muted-foreground leading-relaxed">{t("drybagIII.description")}</p>
            </div>
      ...
      <section className="py-16 lg:py-24 bg-card/30"><div className="container mx-auto px-4 lg:px-8">
