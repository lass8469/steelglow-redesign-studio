...
const StabustrapProduct = () => {
  ...
  useBreadcrumbJsonLd([
    ...
    { name: "Stabustrap", path: `/${language}/stabustrap` },
  ]);
  useJsonLd({
  ...
  const sizes = [
    { weight: "1200mm Standard", description: t("stabustrap.size1.desc"), popular: true },
    { weight: "1200mm Heavy", description: t("stabustrap.size2.desc"), popular: false },
              ...
              <div className="space-y-6">
                <div>
                  <span className="inline-block px-4 py-1.5 mb-4 text-xs font-semibold tracking-widest uppercase bg-primary/10 text-primary border border-primary/20 rounded-full">
                    {t("stabustrap.tagline")}
                  </span>
                  <h1 className="text-4xl lg:text-5xl font-black tracking-tight mb-4">
                    {t("stabustrap.title")}
                    <span className="text-gradient">{t("stabustrap.titleHighlight")}</span>
                  </h1>
                  <p className="text-lg text-muted-foreground leading-relaxed">{t("stabustrap.description")}</p>
                </div>
        ...
        <section className="py-16 lg:py-24">
          <div className="container mx-auto px-4 lg:px-8 text-center">
            <h2 className="text-3xl lg:text-4xl font-black tracking-tight mb-4">
              {t("stabustrap.ctaTitle1")}
              <span className="text-gradient">{t("stabustrap.ctaTitle2")}</span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">{t("stabustrap.ctaDesc")}</p>
