...
const specifications = [
  ...
  { label: "Friction Coefficient", value: "High-grip surface" },
  { label: "Weight", value: "80-120 gsm" },
  { label: "Standard Sizes", value: "600x800mm, 800x1200mm" },
  { label: "Custom Sizes", value: "Available on request" },
  { label: "Certifications", value: "Recyclable, Eco-Friendly" },
];

const sizes = [
  { weight: "600x800mm", description: "Half-pallet size", popular: false },
  { weight: "800x1200mm", description: "Euro pallet size", popular: true },
  { weight: "1000x1200mm", description: "Industrial pallets", popular: false },
...
const features = [
  {
    icon: Layers,
    title: "Enhanced Friction",
    description: "Prevents sliding and shifting between stacked layers.",
  },
  {
    icon: Leaf,
    title: "Eco-Friendly",
    description: "Made from recyclable materials for sustainable packaging.",
  },
  {
    icon: Package,
    title: "Easy to Handle",
    description: "Lightweight sheets for quick, manual application.",
  },
];

const applications = [
  "Palletized Logistics",
  "Food & Beverage Packaging",
  "Industrial Parts & Components",
  "Consumer Products & Retail",
  "Stacked Goods Stability",
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative group">
                ...
                <div className="relative aspect-square rounded-xl overflow-hidden border border-border bg-gradient-to-br from-muted/80 via-muted/40 to-accent/30">
                  ...
                  <img
                    src={productAntislip}
                    alt="Anti-Slip Sheets for Load Stability"
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    Specially designed paper sheets that provide extra friction between 
                    layers of goods, keeping your cargo stable and preventing unwanted 
                    movement during transport and storage.
                  </p>
                </div>
        ...
        <section className="py-16 lg:py-24">
          <div className="container mx-auto px-4 lg:px-8 text-center">
            <h2 className="text-3xl lg:text-4xl font-black tracking-tight mb-4">
              Prevent Load
              <span className="text-gradient"> Shifting?</span>
            </h2>
