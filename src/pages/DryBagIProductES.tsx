...
/**
 * Standalone Spanish-language version of the DRY-BAG I product page.
 * All copy is hardcoded in Spanish — does NOT use the i18n system (en/da only).
 * Route: /es/drybag-i
 */
const DryBagIProductES = () => {
  usePageMeta(
    "DRY-BAG I | Bolsa desecante a base de arcilla para flete marítimo",
    "Bolsa desecante original a base de arcilla para contenedores de flete marítimo. Absorbe el 80% de su propio peso y ofrece hasta 90 días de control de humedad. Conforme con REACH.",
    { ogImage: productDrybagI }
  );

  useJsonLd({
    "@context": "https://schema.org",
    "@type": "Product",
    name: "DRY-BAG I Desecante",
    description:
      "Bolsa desecante a base de arcilla diseñada para travesías oceánicas largas. Absorbe el 80% de su propio peso y ofrece hasta 90 días de protección contra la humedad.",
    ...
    offers: {
      ...
      url: "https://desiccant.com/es/drybag-i",
    },
    additionalProperty: [
      { "@type": "PropertyValue", name: "Material activo", value: "Arcilla bentonita (Mo-Clay)" },
      { "@type": "PropertyValue", name: "Capacidad de absorción", value: "Hasta el 80 % de su peso" },
      { "@type": "PropertyValue", name: "Duración de protección", value: "Hasta 90 días" },
    ],
  });
  ...
  useJsonLd({
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Inicio", item: "https://desiccant.com/es/drybag-i" },
      { "@type": "ListItem", position: 2, name: "Productos", item: "https://desiccant.com/en/products" },
      { "@type": "ListItem", position: 3, name: "DRY-BAG I", item: "https://desiccant.com/es/drybag-i" },
    ],
  });

  const specifications = [
    { label: "Material", value: "Mezcla Moclay" },
    { label: "Capacidad de absorción", value: "80 % de su propio peso" },
    { label: "Duración de protección", value: "Hasta 90 días" },
    { label: "Temperatura de funcionamiento", value: "-5 °C a +50 °C" },
    { label: "Vida útil", value: "24 meses sellado" },
    { label: "Certificaciones", value: "Conforme con REACH" },
  ];

  const sizes = [
    { weight: "1 kg", description: "Contenedores de 40 pies, carga grande", popular: false },
    { weight: "2 kg", description: "Entornos de alta humedad", popular: true },
  ];

  const features = [
    { icon: Anchor, title: "Calidad marítima" },
    { icon: Shield, title: "Protección prolongada" },
    { icon: Package, title: "Diseño a prueba de fugas" },
  ];

  const applications = [
    "Contenedores de flete marítimo",
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 lg:px-8 pt-24 pb-4">
        <nav className="flex items-center space-x-2 text-sm text-muted-foreground">
          ...
          <Link to="/en/products" className="hover:text-primary transition-colors">
            Productos
          </Link>
          <ChevronRight className="h-4 w-4" />
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div className="relative group">
                ...
                <div className="relative aspect-square rounded-xl overflow-hidden border border-border bg-gradient-to-br from-muted/80 via-muted/40 to-accent/30">
                  ...
                  <img
                    src={productDrybagI}
                    alt="Bolsa desecante DRY-BAG I a base de arcilla para el control de humedad en contenedores"
                    loading="lazy"
                    width={600}
                    height={600}
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <h1 className="text-4xl lg:text-5xl font-black tracking-tight mb-4">
                    DRY-BAG I
                    <span className="text-gradient"> Desecante</span>
                  </h1>
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    Bolsa desecante a base de arcilla diseñada para travesías oceánicas largas. Nuestra fórmula
                    original ofrece una adsorción de humedad superior para proteger su carga frente a los daños por
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-6">
                  <Button
                    ...
                    asChild
                  >
                    <a href="mailto:contact@dry-bag.com">Solicitar presupuesto</a>
                  </Button>
        ...
        <section className="py-16 lg:py-24">
          <div className="container mx-auto px-4 lg:px-8 text-center">
            <h2 className="text-3xl lg:text-4xl font-black tracking-tight mb-4">
              ...
              <span className="text-gradient"> carga?</span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
              Póngase en contacto con nuestro equipo para hablar sobre sus necesidades de desecantes para
              contenedores y recibir un presupuesto personalizado.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                ...
                asChild
              >
                <a href="mailto:contact@dry-bag.com">Contactar con ventas</a>
              </Button>
              <Button
                size="lg"
                variant="ghost"
...
export default DryBagIProductES;
