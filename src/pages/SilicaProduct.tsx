...
const specifications = [
  { label: "Material", value: "Premium Silica Gel Beads" },
  { label: "Absorption Capacity", value: "Up to 40% of its weight" },
  { label: "Indicator Type", value: "Blue to Pink / Orange" },
  { label: "Operating Temperature", value: "-40°C to +70°C" },
  { label: "Shelf Life", value: "24 months sealed" },
  { label: "Certifications", value: "FDA, DMF, ISO 9001" },
];

const sizes = [
  { weight: "1g", description: "Small electronics, jewelry", popular: false },
  { weight: "5g", description: "Shoes, handbags, small boxes", popular: true },
  { weight: "10g", description: "Medium packaging, apparel", popular: false },
  { weight: "50g", description: "Large boxes, bulk items", popular: false },
  { weight: "100g", description: "Industrial containers", popular: false },
  { weight: "500g", description: "Shipping containers, pallets", popular: false },
];
...
const features = [
  {
    icon: Shield,
    title: "FDA Approved",
    description: "Safe for food and pharmaceutical applications with full regulatory compliance.",
  },
  {
    icon: Droplets,
    title: "High Absorption",
    description: "Absorbs up to 40% of its weight in moisture for maximum protection.",
  },
  {
    icon: Package,
    title: "Custom Packaging",
    description: "Available in sachets, canisters, and bulk quantities to fit your needs.",
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 lg:px-8 pt-24 pb-4">
        <nav className="flex items-center space-x-2 text-sm text-muted-foreground">
          ...
          <ChevronRight className="h-4 w-4" />
          <span className="text-foreground">Silica Gel</span>
        </nav>
      </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    Premium silica gel packets designed for in-box moisture protection. 
                    Our high-grade desiccant ensures your products arrive in perfect condition, 
                    free from humidity damage.
                  </p>
                </div>
