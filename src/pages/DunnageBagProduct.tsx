...
const specifications = [
  { label: "Material", value: "Kraft Paper & PP Woven" },
  { label: "Inflation Pressure", value: "2-8 PSI adjustable" },
  { label: "Burst Pressure", value: "Up to 15 PSI" },
  { label: "Valve Type", value: "High-flow quick-fill" },
  { label: "Temperature Range", value: "-30°C to +70°C" },
  { label: "Certifications", value: "AAR Approved, ISO 9001" },
];

const sizes = [
  { weight: "Level 1", description: "36\" x 48\" - Light loads", popular: false },
  { weight: "Level 2", description: "36\" x 60\" - Medium cargo", popular: false },
  { weight: "Level 3", description: "48\" x 48\" - Standard pallets", popular: true },
  { weight: "Level 4", description: "48\" x 72\" - Heavy machinery", popular: false },
  { weight: "Level 5", description: "48\" x 84\" - Extra large gaps", popular: false },
  { weight: "Custom", description: "Made to your specifications", popular: false },
];
...
const features = [
  {
    ...
    description: "Prevents shifting and damage during rail, truck, and ocean transport.",
  },
  {
    icon: Shield,
    title: "AAR Approved",
    description: "Meets Association of American Railroads standards for cargo safety.",
  },
  {
    icon: Package,
    title: "Easy Installation",
    description: "Quick-fill valve allows rapid inflation in under 3 seconds.",
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 lg:px-8 pt-24 pb-4">
        <nav className="flex items-center space-x-2 text-sm text-muted-foreground">
          ...
          <ChevronRight className="h-4 w-4" />
          <span className="text-foreground">Dunnage Bag</span>
        </nav>
      </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative group">
                ...
                <div className="relative aspect-square rounded-xl overflow-hidden bg-card border border-border">
                  <img
                    src={productDunnage}
                    alt="Dunnage Bag Cargo Stabilization"
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    Industrial air bags designed for cargo stabilization during transport. 
                    Our dunnage bags prevent load shifting and product damage 
                    across rail, truck, and ocean freight applications.
                  </p>
                </div>
        ...
        <section className="py-16 lg:py-24">
          <div className="container mx-auto px-4 lg:px-8 text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
              Get in touch with our team to discuss your cargo stabilization needs 
