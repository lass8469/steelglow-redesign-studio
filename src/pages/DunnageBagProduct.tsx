...
const DunnageBagProduct = () => {
  ...
  useJsonLd({
    ...
    "@type": "Product",
    name: t("dunnage.title") + " " + t("dunnage.titleHighlight"),
  ...
  const sizes = [
    ...
    { weight: "90x180cm", description: t("dunnage.size4.desc"), popular: true },
    { weight: "90x220cm", description: t("dunnage.size5.desc"), popular: false },
    { weight: "120x180cm", description: t("dunnage.size6.desc"), popular: false },
  ...
  return (
    <div className="min-h-screen bg-background">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <h1 className="text-4xl lg:text-5xl font-black tracking-tight mb-4">
                    {t("dunnage.title")}
                    <span className="text-gradient">{t("dunnage.titleHighlight")}</span>
                  </h1>
                  <p className="text-lg text-muted-foreground leading-relaxed">{t("dunnage.description")}</p>
                </div>
            ...
            <TabsContent value="sizes" className="mt-8">
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {sizes.map((s) => (
                  <Card
                    key={s.weight}
                    className={`bg-card/50 border-border transition-all duration-300 hover:border-primary/50 hover:shadow-lg ${s.popular ? "ring-2 ring-primary/50" : ""}`}
                  >
      ...
      <RelatedProducts productKey="dunnage-bag" />
        ...
        <section className="py-16 lg:py-24">
          <div className="container mx-auto px-4 lg:px-8 text-center">
            <h2 className="text-3xl lg:text-4xl font-black tracking-tight mb-4">
              {t("dunnage.ctaTitle1")}
              <span className="text-gradient">{t("dunnage.ctaTitle2")}</span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">{t("dunnage.ctaDesc")}</p>
