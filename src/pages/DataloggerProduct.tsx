...
const specifications = [
  { label: "Monitoring Duration", value: "Up to 120 days" },
  { label: "Parameters", value: "Temperature & Humidity" },
  { label: "Connectivity", value: "USB plug-and-play" },
  { label: "Report Generation", value: "Automatic PDF/Excel" },
  { label: "Battery Life", value: "Extended for long voyages" },
  { label: "Certifications", value: "CE, FCC Compliant" },
];

const sizes = [
  { weight: "Standard", description: "General cargo monitoring", popular: true },
  { weight: "High-Precision", description: "Pharma & sensitive goods", popular: false },
  { weight: "Multi-Use", description: "Reusable for multiple shipments", popular: false },
  { weight: "Custom", description: "Tailored configurations", popular: false },
];

const features = [
  {
    icon: Thermometer,
    title: "120-Day Monitoring",
    description: "Extended battery for long ocean voyages and storage.",
  },
  {
    icon: Usb,
    title: "Auto Reports",
    description: "Plug into any USB port for instant report generation.",
  },
  {
    icon: Package,
    title: "Compact Design",
    description: "Small, durable device for easy placement in cargo.",
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 lg:px-8 pt-24 pb-4">
        <nav className="flex items-center space-x-2 text-sm text-muted-foreground">
          ...
          <ChevronRight className="h-4 w-4" />
          <span className="text-foreground">Datalogger</span>
        </nav>
      </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <h1 className="text-4xl lg:text-5xl font-black tracking-tight mb-4">
                    Data Logger
                    <span className="text-gradient"> Temperature & Humidity</span>
                  </h1>
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    Invaluable tools for export settings, providing precise monitoring 
                    of environmental conditions throughout shipping. Compact USB devices 
                    automatically generate comprehensive reports for compliance.
                  </p>
                </div>
